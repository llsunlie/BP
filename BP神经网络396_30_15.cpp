...
#define LAYERS  3
// 输入层神经元个数
#define INPUT_NEURONS_NUMBER    396
// 中间层神经元个数
#define MIDDLE_NEURONS_NUMBER   30
// 输出层神经元个数
#define OUTPUT_NEURONS_NUMBER   15
// 训练的最大迭代数
#define MAXIMUM_TRAINING_ROUNDS 10000
// 学习效率
#define LEARNING_EFFICIENCY     0.5
// 平均误差限制
#define AVERAGE_ERROR_LIMIT     0.01
// 图片局部的左上右下的坐标
#define UPPER_LEFT_CORNER_X     40
#define UPPER_LEFT_CORNER_Y     15
#define LOWER_RIGHT_CORNER_X    63
#define LOWER_RIGHT_CORNER_Y    80
// 参数文件
#define PATAMETER_FILEPATH      "parameter396_0.020785.txt"
...
public:
    ...
    void trainingBMPs(){
        ...
        while(trainingRounds-- && averageError > AVERAGE_ERROR_LIMIT){
            // printf("第 %d 次训练迭代开始================================================\n", MAXIMUM_TRAINING_ROUNDS - trainingRounds);
            // 逆序训练
