...
#define LAYERS  3
// 输入层神经元个数
#define INPUT_NEURONS_NUMBER    644
// 中间层神经元个数
...
// 学习效率
#define LEARNING_EFFICIENCY     0.4
// 平均误差限制
#define AVERAGE_ERROR_LIMIT     0.01
// 图片局部的左上右下的坐标
#define UPPER_LEFT_CORNER_X     15
#define UPPER_LEFT_CORNER_Y     30
#define LOWER_RIGHT_CORNER_X    60
#define LOWER_RIGHT_CORNER_Y    85
// 参数文件
#define PATAMETER_FILEPATH      "parameter664_0.017253.txt"
// 每隔多少次迭代保存一次参数
#define SAVE_PARAMETER_ROUNDS   1000
